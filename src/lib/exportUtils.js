// Export utilities for Maths Solver
...
export function exportAsMarkdown(problems, topicLabels) {
  ...
  downloadFile(markdown, 'maths-solver-progress.md', 'text/markdown');
}
...
export function exportAsPDF(problems, topicLabels) {
  ...
  // Title
  doc.setFontSize(20);
  doc.text('Maths Solver Progress', 20, 20);
  ...
  doc.save('maths-solver-progress.pdf');
}
...
export function exportSolutionAsPDF(problem, topic, solution, topicLabels) {
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.setFontSize(9);
    doc.setFont(undefined, 'normal');
    doc.text('Generated by Maths Solver', margin, doc.internal.pageSize.height - 10);
  }
