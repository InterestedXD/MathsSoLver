          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-gray-700 border border-blue-200 dark:border-gray-600 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200">
                Your feedback will be securely stored locally on your device for your reference. We don't collect or share
            ...
            <div className="flex gap-4">
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-secondary-600 to-primary-600 hover:from-secondary-700 hover:to-primary-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
