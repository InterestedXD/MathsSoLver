...
export default function FAQ() {
  ...
  const faqs = [
    {
      question: "Is Maths Solver really free?",
      answer: "Yes! Maths Solver is completely free with no hidden costs or subscriptions. All current features are available to everyone at no charge."
    },
    {
      question: "Do I need to create an account?",
      answer: "No account needed! You can start using Maths Solver immediately. Your problem history is stored locally in your browser using IndexedDB, so your data stays private and on your device."
    },
    {
      question: "Does Maths Solver work offline?",
    ...
    },
    {
      ...
      answer: "Absolutely. Maths Solver is 100% client-side - nothing is sent to our servers because we don't have any! All your problems, solutions, and history are stored locally in your browser's IndexedDB. We never see, collect, or transmit your data."
    },
    {
      question: "What types of math problems can I solve?",
      answer: "Maths Solver supports derivatives, integrals, limits, functions (graphing), trigonometry, algebra (equations, simplification, factoring), and basic arithmetic."
    },
    {
      question: "How accurate are the solutions?",
      answer: "We use industry-standard math libraries for calculations. However, you should always verify solutions independently. Maths Solver is a learning tool, not a replacement for understanding the concepts."
    },
    {
    ...
    {
      question: "Can I use Maths Solver for homework or exams?",
      answer: "Maths Solver is designed as a learning companion. While you can use it to check your work and understand concepts, we recommend using it ethically. Always follow your school's academic integrity policies."
    },
    {
      question: "What browsers are supported?",
      answer: "Maths Solver works on all modern browsers (Chrome, Firefox, Safari, Edge) on desktop and mobile devices. We recommend keeping your browser updated for the best experience."
    },
    {
    ...
    {
      question: "Can I use Maths Solver on my phone?",
      answer: "Yes! Maths Solver is fully responsive and works great on mobile devices. You can even add it to your home screen as a Progressive Web App (PWA) for quick access."
    }
  ];
    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-lg">
          Quick answers to common questions about Maths Solver
        </p>
      </div>
