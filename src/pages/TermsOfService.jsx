      ...
      <Card className="mb-6 border-2 border-purple-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        <CardContent className="p-6">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Welcome to Maths Solver. By accessing or using our educational math
      ...
      <Card className="mb-6 border-2 border-amber-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        <CardContent className="p-6">
          ...
          <p className="text-gray-700 dark:text-gray-300 mt-3">
            We are not responsible for any academic integrity violations resulting
            from misuse of Maths Solver.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6 border-2 border-orange-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2">
            We explicitly disclaim responsibility for any inaccurate, incomplete,
            or misleading information provided by Maths Solver, including but not limited to:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300 ml-4">
      ...
      <Card className="mb-6 border-2 border-teal-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        <CardContent className="p-6 space-y-4">
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Maths Solver, including its design, code, features, and content, is owned by
      ...
      <Card className="mb-6 border-2 border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        <CardContent className="p-6">
          <p className="text-gray-700 dark:text-gray-300">
            ...
            or your use of Maths Solver shall be resolved in accordance with the laws of the
