...
export default function UserManual() {
  usePageTitle("User Manual - How to Use Maths Solver");
    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-lg">
          Learn how to use Maths Solver effectively
        </p>
      </div>
      ...
      <Card className="mb-6 border-2 border-purple-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        <CardContent className="p-6">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Maths Solver is your personal math tutor designed to help you understand and solve precalculus
            and calculus problems step-by-step. Whether you're struggling with derivatives, integrals,
            limits, or basic algebra, Maths Solver guides you through each problem with clear explanations,
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Maths Solver will analyze your problem and provide a complete solution with step-by-step explanations!
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6 border-2 border-orange-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              When applicable, Maths Solver displays an interactive graph to help you visualize the function or solution.
            </p>
          </div>
        </CardContent>
      </Card>
