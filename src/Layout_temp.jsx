...
const navigationItems = [
  ...
  { title: "Solver", url: createPageUrl("Solver"), icon: Calculator },
  { title: "Quiz", url: createPageUrl("Quiz"), icon: BookOpen },
  { title: "My Progress", url: createPageUrl("Progress"), icon: History },
  { title: "Math Community", url: createPageUrl("Community"), icon: MessageSquare },
  { title: "User Manual", url: createPageUrl("UserManual"), icon: BookOpen },
  { title: "FAQ", url: createPageUrl("FAQ"), icon: HelpCircle },
  { title: "Feedback & Support", url: createPageUrl("Feedback"), icon: MessageSquare },
  { title: "Privacy Policy", url: createPageUrl("PrivacyPolicy"), icon: Shield },
  { title: "Terms of Service", url: createPageUrl("TermsOfService"), icon: Scale },
];
          ...
          <Sidebar className="border-r border-purple-100 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm" role="navigation" aria-label="Main navigation">
            <SidebarHeader className="border-b border-purple-100 p-6">
              <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                ...
                />
                <div>
                  <h2 className="font-bold text-xl bg-gradient-to-r from-secondary-600 to-primary-600 bg-clip-text text-transparent">
                    Maths Solver
                  </h2>
            ...
            <header className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-purple-100 dark:border-gray-700 px-6 py-4 shadow-sm" role="banner">
              <div className="flex items-center justify-between">
                ...
                <Link to="/" className="hidden md:flex items-center justify-center gap-2 flex-1 hover:opacity-80 transition-opacity">
                  ...
                  />
                  <h1 className="text-xl font-bold bg-gradient-to-r from-secondary-600 to-primary-600 bg-clip-text text-transparent">
                    Maths Solver <span className="text-base font-normal text-gray-500 dark:text-gray-400">- Master math with confidence</span>
                  </h1>
                </Link>
